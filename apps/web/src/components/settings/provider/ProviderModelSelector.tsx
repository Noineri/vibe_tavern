...
export function ProviderModelSelector({
  ...
  const listModels = selectedModel || !currentValue
    ? filteredModels
    : [{ id: currentValue, label: currentValue, toolSupport: "unknown" as const }, ...filteredModels];
