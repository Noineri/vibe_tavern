...
// Capture request bodies + control the stream.
...
async function mocks() {
  return {
    streamAiAssistant: (await import("../../api/ai-assistant-api.js")).streamAiAssistant,
    updateUiSettings: (await import("../../api/settings-api.js")).updateUiSettings,
