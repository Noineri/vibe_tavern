...
/**
 * Per-send prefill strip (LOCAL_SUPPORT_PLAN LS-4b, owner decisions
 * 2026-09-09). A small collapsible strip OVER the input area that one-shot-
 * overrides the prompt preset's assistant prefill for the NEXT reply, then
 * clears itself — the preset value stays the persistent default (the strip is
 * the same function as the preset's prefill field, surfaced per-send).
 *
 ...
 * plus the prefill capability itself). The component renders null when
 * unsupported — no dead chrome.
 *
