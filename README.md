<div align="center">
  ...
  [![Last Commit](https://img.shields.io/github/last-commit/Noineri/vibe_tavern)](https://github.com/Noineri/vibe_tavern/commits)
...
Vibe Tavern is a local-first AI roleplay platform for building characters, managing lore and personas, assembling prompts, and chatting through OpenAI-compatible providers.

>[!NOTE]
>Vibe Tavern is in active development, so breaking changes or bugs are to be expected. Don't forget to make a backups of your data directory before any update
...
Vibe Tavern is a web app, so it support any OS. Just choose method that you like from list below

### Linux:

#### Option 1. Directly run this project with bun

Install bun, grab latest [Release](https://github.com/Noineri/vibe_tavern/releases) or clone this repo with git, then:
...
Download latest executable from [Releases](https://github.com/Noineri/vibe_tavern/releases) and install Vibe Tavern
...
<div align="center">
  <p>We, the Vibe Tavern team, hope that you enjoy reloplaying in our rp platform</p>
  <p>
    <a href="https://github.com/Noineri/vibe_tavern">GitHub</a> •
    <a href="https://github.com/Noineri/vibe_tavern/issues">Issues</a> •
    <a href="https://github.com/Noineri/vibe_tavern/discussions">Discussions</a>
  </p>
</div>