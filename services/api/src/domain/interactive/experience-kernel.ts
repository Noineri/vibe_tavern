...
// Compatibility re-exports: the PRNG stream, the pure helpers namespace, and
// the payload-schema DSL moved to the zero-dep domain package (RM-3) so the
// browser-side frame kernel port imports the SAME bit-identical code; services
// keep importing them from the kernel unchanged.
export {
