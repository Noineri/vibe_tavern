...
/**
 * Co-Author skill library routes (CTX-S2). Two operations:
 *
 ...
 *
 *  - `DELETE /api/coauthor/skills/:id` — remove one user skill directory.
 *    Built-in skill ids are rejected by the service (built-in immutability).
 *
 * Catalog list/read endpoints land in CTX-S3.
 */
