...
- Use `edit_profile` only for a deliberate full-document rebuild touching multiple sections and/or frontmatter at once — and only as the first profile change in the turn.
