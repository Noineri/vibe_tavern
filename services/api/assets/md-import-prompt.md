...
Extraction rules:
- Copy source text into the best matching field. Do not summarize, sanitize, moralize, translate, or rewrite.
...
- tagline = a short hook/bio line if the source provides one. Omit if absent.
